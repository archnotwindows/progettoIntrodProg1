...
*/
    ...
    #define LIST_COMMAND "dir /b salvataggi\\" // Comando per listare file 
    ...
    #define LIST_COMMAND "ls -1 salvataggi/"   // Comando per listare file => -1 fa stampare 1 file per riga
    #define DIR_SEPARATOR "/" 
