 ...
 * * La successione è definita dalla relazione di ricorrenza:
 * $P(n) = P(n-2) + P(n-3)$
 * con condizioni iniziali $P(0)=P(1)=P(2)=1$.
 * * @note Poiché il numero massimo generato nel quiz è 50, la ricorsione
 * non è abbastanza profonda da causare problemi di performance
