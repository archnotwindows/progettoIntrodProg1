...
* * Qui di gestisce il villaggio, da cui il giocatore può:
* - accedere alle missioni
...
* * Questa funzione mostra un menu che permette al giocatore di organizzarsi prima di una missione.
* Gestisce anche il controllo del "Game Over" alla fine delle missioni.
* * @param giocatore_ptr Puntatore alla struttura dati Giocatore per modificare vita, inventario e stato missioni.
*/
void menuVillaggio(Giocatore* giocatore_ptr) {
    
    /** * @brief Loop infinito del villaggio.
    * Il giocatore rimane in questo ciclo finché non sceglie di uscire (opzione 5) o muore in missione (Game Over).
    */
    while (1) {
        puliscischermo();
        printf("===== VILLAGGIO =====\n");
        ...
        /* Opzione 4: Salvataggio */
            ...
            * funzione definita in salvataggi.h.
            */
