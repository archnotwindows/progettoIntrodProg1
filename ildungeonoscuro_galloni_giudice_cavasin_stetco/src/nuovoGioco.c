...
#define _POSIX_C_SOURCE 200809L // Macro per garantire compatibilità POSIX => permette la compatibilità tra OS windows e unix di anni differenti
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
 ...
 * * Sostituisce la scanf per evitare problemi
