...
* L'obiettivo è sconfiggere 3 Generali mostri entro 10 stanze.
* Il sistema utilizza la TabellaPalude definita in tabellemissioni.h per determinare cosa accade in base al lancio del dado.
*/
...
* * La funzione determina l'evento della stanza basandosi sul caso o sulla necessità di completare l'obiettivo. 
* Gestisce il combattimento, il calcolo dei danni, le ricompense e l'aggiornamento degli obiettivi.
...
void esplora1StanzaDungeon(Giocatore* giocatore_ptr, int* stanza_corrente, int* generali_uccisi) {
    ...
    * Questo impedisce al giocatore di fallire la missione solo per sfortuna con i dadi.
    */
